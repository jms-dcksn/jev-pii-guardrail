...
```python
# Close the HTTP clients owned by this service.
sdk.automation_ops.aclose() -> None
...
```python
# Close the HTTP clients owned by this service.
sdk.automation_tracker.aclose() -> None
...
```python
# Close the HTTP clients owned by this service.
sdk.context_grounding.aclose() -> None
...
sdk.context_grounding.start_deep_rag_from_attachments(name: str, prompt: Annotated[str, FieldInfo(annotation=NoneType, required=True, metadata=[MaxLen(max_length=250000)])], attachments: List[str], citation_mode: <enum 'CitationMode="CitationMode.INLINE", folder_key: str | None=None, folder_path: str | None=None) -> uipath.platform.context_grounding.context_grounding.DeepRagCreationResponse

# Asynchronously starts a Deep RAG task by creating an ephemeral index from attachments in a single call.
sdk.context_grounding.start_deep_rag_from_attachments_async(name: str, prompt: Annotated[str, FieldInfo(annotation=NoneType, required=True, metadata=[MaxLen(max_length=250000)])], attachments: List[str], citation_mode: <enum 'CitationMode="CitationMode.INLINE", folder_key: str | None=None, folder_path: str | None=None) -> uipath.platform.context_grounding.context_grounding.DeepRagCreationResponse
...
```python
# Close the HTTP clients owned by this service.
sdk.conversational.aclose() -> None
...
sdk.entities.create_entity_v3(name: str, fields: List[uipath.platform.entities.entities.EntityCreateFieldOptions], options: Optional[uipath.platform.entities.entities.EntityCreateOptions]=None) -> str

# Async variant of :meth:`create_entity_v3`.
sdk.entities.create_entity_v3_async(name: str, fields: List[uipath.platform.entities.entities.EntityCreateFieldOptions], options: Optional[uipath.platform.entities.entities.EntityCreateOptions]=None) -> str
...
sdk.entities.delete_entity_v3(entity_id: str) -> None

# Async variant of :meth:`delete_entity_v3`.
sdk.entities.delete_entity_v3_async(entity_id: str) -> None
...
sdk.entities.delete_record_v3(entity_key: str, record_id: str) -> None

# Async variant of :meth:`delete_record_v3`.
sdk.entities.delete_record_v3_async(entity_key: str, record_id: str) -> None
...
sdk.entities.delete_records_v3(entity_key: str, record_ids: List[str], fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse

# Async variant of :meth:`delete_records_v3`.
sdk.entities.delete_records_v3_async(entity_key: str, record_ids: List[str], fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse
...
sdk.entities.get_ontology_file_async(ontology_name: str, file_type: str="owl", folder_key: Optional[str]=None) -> typing.Dict[str, typing.Any]
...
sdk.entities.get_record_v3(entity_key: str, record_id: str, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord

# Async variant of :meth:`get_record_v3`.
sdk.entities.get_record_v3_async(entity_key: str, record_id: str, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord
...
sdk.entities.insert_record_v3(entity_key: str, data: Any, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord

# Async variant of :meth:`insert_record_v3`.
sdk.entities.insert_record_v3_async(entity_key: str, data: Any, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord
...
sdk.entities.insert_records_v3(entity_key: str, records: List[Any], schema: Optional[Type[Any]]=None, expansion_level: Optional[int]=None, fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse

# Async variant of :meth:`insert_records_v3`.
sdk.entities.insert_records_v3_async(entity_key: str, records: List[Any], schema: Optional[Type[Any]]=None, expansion_level: Optional[int]=None, fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse
...
sdk.entities.list_entities_v3() -> typing.List[uipath.platform.entities.entities.Entity]

# Async variant of :meth:`list_entities_v3`.
sdk.entities.list_entities_v3_async() -> typing.List[uipath.platform.entities.entities.Entity]

# List records from an entity with optional pagination and schema validation.
sdk.entities.list_records(entity_key: str, schema: Optional[Type[Any]]=None, start: Optional[int]=None, limit: Optional[int]=None, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecordsListResponse

# Asynchronously list records from an entity with optional pagination and schema validation.
sdk.entities.list_records_async(entity_key: str, schema: Optional[Type[Any]]=None, start: Optional[int]=None, limit: Optional[int]=None, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecordsListResponse

# List entity records via the v3 API.
sdk.entities.list_records_v3(entity_key: str, schema: Optional[Type[Any]]=None, start: Optional[int]=None, limit: Optional[int]=None, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecordsListResponse

# Async variant of :meth:`list_records_v3`.
sdk.entities.list_records_v3_async(entity_key: str, schema: Optional[Type[Any]]=None, start: Optional[int]=None, limit: Optional[int]=None, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecordsListResponse

# Query entity records using a validated SQL query.
sdk.entities.query_entity_records(sql_query: str, relationships_as_scalar: bool=False, resolve_choice_sets: bool=False) -> typing.List[typing.Dict[str, typing.Any]]

# Asynchronously query entity records using a validated SQL query.
sdk.entities.query_entity_records_async(sql_query: str, relationships_as_scalar: bool=False, resolve_choice_sets: bool=False) -> typing.List[typing.Dict[str, typing.Any]]
...
sdk.entities.resolve_entity_set_v3(items: List[uipath.platform.entities.entities.DataFabricEntityItem]) -> uipath.platform.entities.entities.EntitySetResolution

# Async variant of :meth:`resolve_entity_set_v3`.
sdk.entities.resolve_entity_set_v3_async(items: List[uipath.platform.entities.entities.DataFabricEntityItem]) -> uipath.platform.entities.entities.EntitySetResolution
...
sdk.entities.retrieve_by_name_v3(entity_name: str, folder_key: Optional[str]=None) -> uipath.platform.entities.entities.Entity

# Async variant of :meth:`retrieve_by_name_v3`.
sdk.entities.retrieve_by_name_v3_async(entity_name: str, folder_key: Optional[str]=None) -> uipath.platform.entities.entities.Entity
...
sdk.entities.retrieve_records_v3(entity_key: str, filter_group: Optional[uipath.platform.entities.entities.EntityQueryFilterGroup]=None, sort_options: Optional[List[uipath.platform.entities.entities.EntityQuerySortOption]]=None, selected_fields: Optional[List[str]]=None, expansions: Optional[List[Any]]=None, expansion_level: Optional[int]=None, aggregates: Optional[List[uipath.platform.entities.entities.EntityAggregate]]=None, group_by: Optional[List[str]]=None, joins: Optional[List[uipath.platform.entities.entities.EntityJoin]]=None, binnings: Optional[List[uipath.platform.entities.entities.EntityBinning]]=None, start: Optional[int]=None, limit: Optional[int]=None) -> uipath.platform.entities.entities.RetrieveEntityRecordsResponse

# Async variant of :meth:`retrieve_records_v3`.
sdk.entities.retrieve_records_v3_async(entity_key: str, filter_group: Optional[uipath.platform.entities.entities.EntityQueryFilterGroup]=None, sort_options: Optional[List[uipath.platform.entities.entities.EntityQuerySortOption]]=None, selected_fields: Optional[List[str]]=None, expansions: Optional[List[Any]]=None, expansion_level: Optional[int]=None, aggregates: Optional[List[uipath.platform.entities.entities.EntityAggregate]]=None, group_by: Optional[List[str]]=None, joins: Optional[List[uipath.platform.entities.entities.EntityJoin]]=None, binnings: Optional[List[uipath.platform.entities.entities.EntityBinning]]=None, start: Optional[int]=None, limit: Optional[int]=None) -> uipath.platform.entities.entities.RetrieveEntityRecordsResponse

# Retrieve an entity by key via the v3 API.
sdk.entities.retrieve_v3(entity_key: str) -> uipath.platform.entities.entities.Entity

# Async variant of :meth:`retrieve_v3`.
sdk.entities.retrieve_v3_async(entity_key: str) -> uipath.platform.entities.entities.Entity
...
sdk.entities.update_entity_metadata_v3(entity_id: str, metadata: Union[uipath.platform.entities.entities.EntityMetadataUpdateOptions, Dict[str, Any]]) -> None

# Async variant of :meth:`update_entity_metadata_v3`.
sdk.entities.update_entity_metadata_v3_async(entity_id: str, metadata: Union[uipath.platform.entities.entities.EntityMetadataUpdateOptions, Dict[str, Any]]) -> None
...
sdk.entities.update_record_v3(entity_key: str, record_id: str, data: Any, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord

# Async variant of :meth:`update_record_v3`.
sdk.entities.update_record_v3_async(entity_key: str, record_id: str, data: Any, expansion_level: Optional[int]=None) -> uipath.platform.entities.entities.EntityRecord
...
sdk.entities.update_records_v3(entity_key: str, records: List[Any], schema: Optional[Type[Any]]=None, expansion_level: Optional[int]=None, fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse

# Async variant of :meth:`update_records_v3`.
sdk.entities.update_records_v3_async(entity_key: str, records: List[Any], schema: Optional[Type[Any]]=None, expansion_level: Optional[int]=None, fail_on_first: Optional[bool]=None) -> uipath.platform.entities.entities.EntityRecordsBatchResponse
...
```python
# Close the HTTP clients owned by this service.
sdk.governance.aclose() -> None

# POST a compensating ``/runtime/govern`` call.
sdk.governance.compensate(hook: str, validators: list[str], rules: list[uipath.core.governance.providers.FiredRule], data: dict[str, Any], src_timestamp: str, agent_name: str, runtime_id: str, trace_id: str | None=None, folder_key: str | None=None, job_key: str | None=None, process_key: str | None=None, reference_id: str | None=None, agent_version: str | None=None) -> None
...
sdk.mcp.retrieve(slug: str | None=None, name: str | None=None, folder_path: str | None=None) -> uipath.platform.orchestrator.mcp.McpServer

# Asynchronously retrieve an MCP server by its display name or legacy slug.
sdk.mcp.retrieve_async(slug: str | None=None, name: str | None=None, folder_path: str | None=None) -> uipath.platform.orchestrator.mcp.McpServer
...
```python
# Close the HTTP clients owned by this service.
sdk.orchestrator_setup.aclose() -> None
...
sdk.remote_a2a.retrieve(slug: str | None=None, name: str | None=None, folder_path: str | None=None) -> uipath.platform.agenthub.remote_a2a.RemoteA2aAgent

# Asynchronously retrieve a Remote A2A agent by display name or legacy slug.
sdk.remote_a2a.retrieve_async(slug: str | None=None, name: str | None=None, folder_path: str | None=None) -> uipath.platform.agenthub.remote_a2a.RemoteA2aAgent
...
```python
# Close the HTTP clients owned by this service.
sdk.resource_catalog.aclose() -> None
...
```python
# Close the HTTP clients owned by this service.
sdk.semantic_proxy.aclose() -> None
